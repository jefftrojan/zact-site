    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto text-center mb-14">
          <div className="inline-flex items-center gap-2 zact-pill text-foreground px-4 py-2 text-sm font-medium">Security</div>
          <h1 className="mt-4 text-4xl md:text-6xl font-display font-semibold text-foreground">Security at Zact</h1>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-8">
          <aside className="hidden md:block md:col-span-3">
            <div className="sticky top-24 zact-glass-card-soft p-4">
          ...
          <div className="md:col-span-9 space-y-6">
            <section id="overview" className="zact-glass-card p-6">
            ...
            <section id="encryption" className="zact-glass-card p-6">
            ...
            <section id="access" className="zact-glass-card p-6">
            ...
            <section id="compliance" className="zact-glass-card p-6">
            ...
            <section id="incident" className="zact-glass-card p-6">
            ...
            <section id="disclosure" className="zact-glass-card p-6">
            ...
            <section id="subprocessors" className="zact-glass-card p-6">
            ...
            <section id="contact" className="zact-glass-card p-6">
